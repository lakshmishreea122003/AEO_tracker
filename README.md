...
- celery should be include. But redis which is required for celery is not getting installed on my windows. I will take permission to install it on my college's system and complete the project.
